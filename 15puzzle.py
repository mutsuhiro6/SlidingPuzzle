        ...
        if n.state == goal:
            ...
            for s in adjacent[n.space]:
                ...
                if not key in close:
                    ...
                    close[key] = True
                    extracted += 1
                    sys.stdout.write("\r Extracted %d nodes." % extracted)
                    sys.stdout.flush()                    
...
def initialStateGen():
    ...
    i = 362880
    while i:
        sys.stdout.write("\rGenerating starts...%d" % i)
        sys.stdout.flush()
        shuffled = list(start)
...
def solve():
    ...
    #start = [8,6,7,2,5,4,3,0,1]
    #start = [6,4,7,8,5,0,3,2,1]
    #start = [1,2,3,4,12,13,14,5,11,0,15,6,10,9,8,7]
    #start = [2,4,10,5,4,6,7,15,8,1,12,11,13,9,14,0]
    start = [1,2,3,4,6,7,8,0,5,10,11,12,9,13,14,15]
